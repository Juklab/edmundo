...
public class tick_box extends Actor
{
    ...
    private static boolean breakLow = true; // when true, with low-percent values bar is dangerColor, else safeColor; reversed when false
    ...
    private Color safeColor = Color.WHITE; // the color of the bar while in the safe range
...
//  The color of the bar AT the breakpoint will be the average color between the safe color and the danger color
    private float fontSize = 26.0f; // the size of the text
    ...
    public tick_box(String refText, String unitType, int initValue, int maxValue)
    {
    ...
    public boolean getUsingBreakValue() { return usingBreakValue; }
